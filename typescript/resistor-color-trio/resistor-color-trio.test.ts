...
describe("Resistor Colors", () => {
    ...
    it("Blue and grey and brown", () => {
        expect(decodedResistorValue(["blue", "grey", "brown"])).toEqual(
            "680 ohms",
        )
    })

    it("Red and black and red", () => {
        expect(decodedResistorValue(["red", "black", "red"])).toEqual(
            "2 kiloohms",
        )
    })
    ...
    it("Minimum possible value", () => {
        expect(decodedResistorValue(["black", "black", "black"])).toEqual(
            "0 ohms",
        )
    })
    ...
    it("First two colors make an invalid octal number", () => {
        expect(decodedResistorValue(["black", "grey", "black"])).toEqual(
            "8 ohms",
        )
    })
